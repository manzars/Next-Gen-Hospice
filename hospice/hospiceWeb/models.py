...
class Admission(models.Model):
    ...
    dischargedate = models.DateTimeField(db_column='dischargeDate', blank=True, null=True)  # Field name made lowercase.
    ...
    medbill = models.IntegerField(db_column='medBill', blank=True, null=True)  # Field name made lowercase.
    labbill = models.IntegerField(db_column='labBill', blank=True, null=True)  # Field name made lowercase.
    totalbill = models.IntegerField(db_column='totalBill', blank=True, null=True)  # Field name made lowercase.
